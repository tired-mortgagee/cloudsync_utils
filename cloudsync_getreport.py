...
report_id = "62036415ecfa624e25e64360"
string_url = "https://api.cloudsync.netapp.com/api/accounts/"+string_account+"/reports/"+report_id
...
with open("./createreportrequest.json") as handle_file:
    post_data = json.load(handle_file)
handle_file.close()
...
obj_response = requests.get(url = string_url, headers=json_headers)
if bool_debug:
